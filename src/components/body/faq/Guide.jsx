    ...
    return (
      ...
      <div className="row mb-5">
        <div className="col-sm-12 col-lg-10 offset-lg-1  u__center-faq">
          ...
          Once you sign in to Fiverr, you will receive an activation email. Just click the link in the activation email
          ...
          <br/>
          <br/>
          <img src={require("assets/image/common/guide-sample-1.png")} alt="login guide"/>
