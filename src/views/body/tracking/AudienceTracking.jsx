...
class AudienceTracking extends React.Component {
  ...
  render() {
    ...
    const addr = restapi.getThumbnail(location.state.documentId, 1);
              ...
              <div className="col-sm-3 col-md-3 col-thumb">
                <Link to={"/content/view/" + location.state.documentId}>
                  <div className="thumb_image">
                    <img src={addr}
                         alt={location.state.title ? location.state.title : location.state.documentName} className="img-fluid"/>
                  </div>
                </Link>
              </div>
              ...
              <div className="col-sm-12 col-md-12">
                ...
                <div className="tracking_table">
                  <table border="0" cellSpacing="0" cellPadding="0">
                    <colgroup>
                      <col width="60%" className="col1"/>
                      <col width="20%" className="col2"/>
                      <col width="20%" className="col3"/>
                    </colgroup>
                    <tr>
